...
const routes: Routes = [
  ...
  { path: 'space', canActivate: [AuthGuard], loadChildren: () => import('./space/space.module').then(m => m.SpaceModule), data: {breadcrumb: 'library'} },
  { path: 'upload', canActivate: [AuthGuard], loadChildren: () => import('./upload/upload.module').then(m => m.UploadModule), data: {breadcrumb: 'upload Books/Notes'} },
