...
import { IOrder } from 'src/app/model/order/order';
...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  async submitOrder() {
    ...
    try {
      ...
      // Revisit this payment logic once integration with payment gateway in process
      //const paymentResult = await this.confirmPaymentWithStripe(basket);

      //if (paymentResult.paymentIntent) /// Payment confirmatoin check
       //{

       // For now assumeing payment is successfull
       debugger
  ...
  private getOrderToCreate(basket: IBasket) {
    return {
      ...
      addressRequest: this.checkoutForm.get('addressForm').value,
    };
  }
}
