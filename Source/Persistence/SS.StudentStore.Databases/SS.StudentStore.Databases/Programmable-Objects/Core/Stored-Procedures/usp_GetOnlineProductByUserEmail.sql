Create Procedure [Core].[usp_GetOnlineProductByUserEmail]
@userEmail nvarchar(100),
@ebookProductTypeId Int = 0,
@subscribeProductTypeId int = 0
As 
Begin

select P.[ProductId],P.[ProductTypeId], P.[Title], P.[Name], P.[Description], P.[ProductTypeName], OI.[Price],P.[CategoryId],P.[CategoryName] ,P.[SubCategoryId], P.[SubCategoryName], 
...
PT.ProductTypeId in (@ebookProductTypeId,@subscribeProductTypeId) And
OI.[IsActive] = 1  
